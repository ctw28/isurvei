...
<head>
    ...
    <link rel="stylesheet" href="196807022000031007font/CS-Interface/style.css" />
    <!-- Font Tags End -->
    <!-- Vendor Styles Start -->
                    ...
                    <ul id="menu" class="menu">
                        <li>
                            <a href="Horizontal.html">
                                <i data-cs-icon="grid-2" class="icon" data-cs-size="18"></i>
                                <span class="label">Horizontal</span>
                            </a>
                        </li>
                        <li>
                            <a href="Vertical.html">
                                <i data-cs-icon="grid-3" class="icon" data-cs-size="18"></i>
